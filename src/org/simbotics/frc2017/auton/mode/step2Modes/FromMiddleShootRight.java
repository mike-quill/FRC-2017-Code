...
public class FromMiddleShootRight implements AutonMode {
	...
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveStraightProfile(-2.0,105,0.01,1200)); // drive to gear peg
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new DriveTurnToAnglePID(150,0.75 ,1.0, 500));
		
		ab.addCommand(new DriveStraightProfile(-6.4,150,10,0.25,0.5,2150)); // drive to gear peg
		ab.addCommand(new DriveWait());
		...
		ab.addCommand(new DriveStraightProfile(17.0, 90, 0.01, 2500)); // drive to gear peg
