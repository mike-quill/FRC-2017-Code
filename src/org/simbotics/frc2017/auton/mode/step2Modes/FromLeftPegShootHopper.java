...
public class FromLeftPegShootHopper implements AutonMode {

	@Override
	public void addToMode(AutonBuilder ab) {
		ab.addCommand(new TurretMoveToAngle(170, 1500));
		
		ab.addCommand(new Drive2dProfile("LeftSideGearCurveHopperReverse",true, 14, -1,-1,1.0,4.0, 4.2,0.012,1800));
		
		ab.addCommand(new DriveTurnLeftUntilAngle(1.0,150,500));
		ab.addCommand(new ShooterSetRPM(RobotConstants.ADJUSTABLE_RPM, 0.0));
		ab.addCommand(new SetBallRamp(true));
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new DriveStraightProfile(28 / 12.0, 180, 0.01, 800));
		ab.addCommand(new DriveSetHighGear(false));
		ab.addCommand(new TurretAim(170, 3000));
		ab.addCommand(new DriveStraightProfile(12 / 12.0, 180, 0.01, 600));
