...
public class MoveToOtherHopperRightGearHopper implements AutonMode {
	...
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveTurnToAngleLeftSide(-125,5,1000));
		ab.addCommand(new DriveStraightProfile(-9.5,-125, 0.01, 1500));
		
		ab.addCommand(new DriveTurnToAnglePID(-215,2,1000));
		ab.addCommand(new DriveStraightProfile(16.0, -215, 0.01, 2000));
