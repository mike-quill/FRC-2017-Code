...
public class RightScoreSideGear implements AutonMode{

	@Override
	public void addToMode(AutonBuilder ab) {
		ab.addCommand(new DriveSetHighGear(true));
		ab.addCommand(new Drive2dProfile("RightSideGearCurve",false, 8, 0.01,0.012 ,2500));
		ab.addCommand(new PouchScoreGearWhenSensor(3500));
		ab.addCommand(new DriveStraightProfile(6 / 12.0, 150, 0.01, 500));
