...
public class LeftShootThenSideGear implements AutonMode{

	@Override
	public void addToMode(AutonBuilder ab) {
		ab.addCommand(new TurretSetPosition(190));
		ab.addCommand(new ShooterSetRPM(RobotConstants.ADJUSTABLE_RPM, 0.0));
		ab.addCommand(new TurretAim(190, 1500));
		...
		ab.addCommand(new DriveStraightProfile(103.0 / 12.0, 90, 9.0, 0.01, 3000));
		ab.addCommand(new DriveTurnToAnglePID(35, 0.01, 1000));
		
		ab.addCommand(new DriveStraightProfile(35 / 12.0, 35, 4.0, 0.01, 2000));
		ab.addCommand(new DriveSetOutput(0.2));
		ab.addCommand(new PouchScoreGearWhenSensor(2500));
		ab.addCommand(new PouchWait());
		
		
		ab.addCommand(new DriveStraightProfile(-26 / 12.0, 50,14.0, 0.3, 1.0, 1500));
		ab.addCommand(new DriveTurnToAnglePID(105,1.0,500));
		ab.addCommand(new DriveStraightProfile(184 / 12.0, 105, 14.0, 0.01, 3500));
