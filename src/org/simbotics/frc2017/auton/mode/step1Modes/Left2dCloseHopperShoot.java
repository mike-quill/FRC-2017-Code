...
public class Left2dCloseHopperShoot implements AutonMode{
	...
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new Drive2dProfile("LeftHopperCurve",false, 8, 0.01, 1800));
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new TurretAim(170, 3200));
		ab.addCommand(new DriveSetHighGear(false));
		ab.addCommand(new DriveStraightProfile(20 / 12.0, 180, 0.01, 1200));
