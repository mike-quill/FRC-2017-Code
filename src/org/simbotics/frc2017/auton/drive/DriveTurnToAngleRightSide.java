...
public class DriveTurnToAngleRightSide extends AutonCommand {
	...
	public DriveTurnToAngleRightSide(double target, double eps, long timeOut) {
		this(target, 1.0, eps, timeOut);
	}
	
	public DriveTurnToAngleRightSide(double target, long timeOut){
		this(target,1.0,-1,timeOut);
	}

	public DriveTurnToAngleRightSide(double target, double maxOutput,double eps,long timeOut) {
	...
	public boolean calculate() {
		...
		if (this.gyroControl.isDone()) {
			...
			this.robotOut.setDriveLeft(-0.1);
